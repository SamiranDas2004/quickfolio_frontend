...
import { IconBrandGithub, IconBrandTwitter, IconBrandLinkedin, IconMail, IconWorld } from "@tabler/icons-react";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="relative flex min-h-screen w-full items-center justify-center bg-black overflow-x-hidden">
        <div
          className={cn(
            "absolute inset-0",
      ...
      <section className="min-h-screen w-full flex flex-col items-center justify-center bg-black py-20 overflow-x-hidden">
        <div className="text-center mb-12 px-6">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">Be outstanding</h2>
          <p className="text-xl md:text-2xl text-zinc-400 mb-2">Let's be honest, nobody reads resumes anymore.</p>
          <p className="text-xl md:text-2xl text-zinc-400">This is the best way to sell yourself.</p>
        </div>
...
*/}
      ...
      <section className="w-full bg-black py-28 overflow-x-hidden">
        <div className="text-center mb-12 px-6">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-4">Portfolio Examples</h2>
          <p className="text-xl text-zinc-400">See what others have created</p>
        </div>
      ...
      <section className="w-full bg-black py-20">
        <div className="max-w-4xl mx-auto px-6">
          <h2 className="text-4xl md:text-6xl font-bold text-white mb-12 text-center">Frequently Asked Questions</h2>
          <div className="space-y-6">
            <details className="group border-b border-zinc-800 pb-6">
              <summary className="flex justify-between items-center cursor-pointer text-xl font-semibold text-white">
                How does quickfolio work?
                <span className="text-2xl group-open:rotate-45 transition-transform">+</span>
              </summary>
              <p className="mt-4 text-zinc-400">Simply upload your resume or LinkedIn profile, and our AI will analyze your information to create a stunning, interactive portfolio website. The entire process takes just a few minutes.</p>
            </details>
            ...
            <details className="group border-b border-zinc-800 pb-6">
              ...
              <p className="mt-4 text-zinc-400">Yes! While our AI creates the initial design, you can customize colors, layouts, and content to match your personal brand and style.</p>
            </details>
            ...
            <details className="group border-b border-zinc-800 pb-6">
              ...
              <p className="mt-4 text-zinc-400">Absolutely! Every portfolio comes with a custom quickfolio.dev subdomain, and you can also connect your own custom domain if you prefer.</p>
            </details>
            ...
            <details className="group border-b border-zinc-800 pb-6">
              ...
              <p className="mt-4 text-zinc-400">quickfolio uses AI to create interactive portfolios where visitors can chat with an AI version of you. It's not just a static website—it's an engaging experience that showcases your personality and expertise.</p>
            </details>
            ...
            <details className="group border-b border-zinc-800 pb-6">
              ...
              <p className="mt-4 text-zinc-400">We offer flexible pricing plans starting from free for basic portfolios. Premium plans include advanced AI features, custom domains, and analytics. Check our pricing page for detailed information.</p>
            </details>
          </div>
        </div>
      </section>
      ...
      <footer className="w-full bg-black border-t border-zinc-800 py-12">
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <p className="text-zinc-400 text-sm">&copy; 2026 quickfolio. All rights reserved. A product by <a href="https://42vectors.com/" target="_blank" rel="noopener noreferrer" className="text-zinc-300 hover:text-white transition">42vectors</a></p>
              ...
              <FloatingDock
                items={[
                  ...
                  },
                  {
                    ...
                    href: "https://www.linkedin.com/in/samiran-das-dev/",
                  },
                  {
                    title: "Twitter",
                    icon: <IconBrandTwitter className="h-full w-full text-neutral-500 dark:text-neutral-300" />,
                    href: "https://x.com/SamiranDas2004",
                  },
                  {
                    title: "GitHub",
                    icon: <IconBrandGithub className="h-full w-full text-neutral-500 dark:text-neutral-300" />,
                    href: "https://github.com/SamiranDas2004",
                  },
                ]}
              />
            </div>
