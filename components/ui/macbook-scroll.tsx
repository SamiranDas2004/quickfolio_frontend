  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="mb-20 text-center text-5xl md:text-7xl font-bold text-white"
      >
        {title || (
          <span>
  ...
  return (
    <div className="mx-1 h-full rounded-md bg-[#050505] p-1">
      ...
      <div className="mb-[2px] flex w-full gap-[2px]">
        ...
        <KBtn><div className="h-4 w-4 rounded-full bg-gradient-to-b from-neutral-900 via-black to-neutral-900 p-px"><div className="h-full w-full rounded-full bg-black" /></div></KBtn>
      </div>
      ...
      <div className="flex w-full gap-[2px]">
        <KBtn className="w-8"><span className="text-[4px]">fn</span></KBtn>
        <KBtn className="w-8"><span className="text-[4px]">control</span></KBtn>
        <KBtn className="w-8"><span className="text-[4px]">option</span></KBtn>
        <KBtn className="w-12"><span className="text-[4px]">command</span></KBtn>
